...
namespace ComponentInspectorTool
{
    [CustomEditor(typeof(GameObject), true)]      
    [CanEditMultipleObjects]
	public class ComponentInspectorTool : Editor
	{
        ...
        void DrawElements(Rect originalRect, Component component){
            ...
            if ( ! isTransform || isRectTransform){
                ...
                Texture buttonIcon = EditorGUIUtility.IconContent("Toolbar Minus").image;   // Toolbar Minus  // TL Close button act
